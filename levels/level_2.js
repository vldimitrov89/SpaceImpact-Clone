...
import { PlayerInvert } from '../player.js';
import GameOver from './game_over.js';
import { SpritesInvert } from '../sprites.js';
...
export default function LevelTwo(score) {

    const SCORE_GOAL = (score + BOSS_HEALTH) * 2;

    k.scene("level2", (score) => {

        // background image
        add([
            sprite("background_invert"),
            pos(height(), width()),
            origin("center"),
            //layer("bg"),
        ]);

        const objs = SpritesInvert();
